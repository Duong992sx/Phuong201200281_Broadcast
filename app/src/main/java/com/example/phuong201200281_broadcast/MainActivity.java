    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.idxoa:
                ...
                dlgAlert.setMessage("Tong Doan wants to delete?");
...
//                                ContacList.remove(selectedid);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.addContact(new ThuChi("Lương","29-11-2023",13021230,true));
        db.addContact(new ThuChi("Góp tiền ăn tối","20-01-2023",3000000,false));
        db.addContact(new ThuChi("Thuê nhà","20-01-2023",2000000,false));
        db.addContact(new ThuChi("Làm thêm","29-11-2023",4321232,true));
       ...
       // Giảm
        Collections.sort(ContacList, new Comparator<ThuChi>() {
            ...
            public int compare(ThuChi o1, ThuChi o2) {
                return o2.getSotien() - o1.getSotien();
            }
        });
